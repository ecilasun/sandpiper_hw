...
module blockone
   (BUTTON_tri_i,
    ...
    UART_0_0_rxd,
    UART_0_0_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 BUTTON TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [1:0]BUTTON_tri_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_0_0 TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [2:0]GPIO_0_0_tri_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 LED TRI_O" *) (* X_INTERFACE_MODE = "Master" *) output [1:0]LED_tri_o;
  ...
  wire [2:0]GPIO_0_0_tri_i;
  wire [2:0]GPIO_0_0_tri_o;
  wire [2:0]GPIO_0_0_tri_t;
  wire HDMI_CLK_n_0;
  wire HDMI_CLK_p_0;
  ...
  blockone_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(BUTTON_tri_i),
        .gpio_io_o(LED_tri_o),
  ...
  blockone_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
