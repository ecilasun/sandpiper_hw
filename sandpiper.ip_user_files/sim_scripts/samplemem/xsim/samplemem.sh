...
#
# Script generated by Vivado on Mon May 19 01:06:17 -0700 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : samplemem.sh
...
#
# Usage        : samplemem.sh
#                samplemem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                samplemem.sh [-reset_run]
#                samplemem.sh [-reset_log]
#                samplemem.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L smartconnect_v1_0 -L xilinx_vip"

# script info
echo -e "samplemem.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./samplemem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot samplemem xil_defaultlib.samplemem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim samplemem -key {Behavioral:sim_1:Functional:samplemem} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4389.protoinst" -protoinst "protoinst_files/blockone.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb samplemem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./samplemem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: samplemem.sh [-help]\n\
Usage: samplemem.sh [-step]\n\
Usage: samplemem.sh [-lib_map_path]\n\
Usage: samplemem.sh [-reset_run]\n\
Usage: samplemem.sh [-reset_log]\n\
Usage: samplemem.sh [-keep_index]\n\
Usage: samplemem.sh [-noclean_files]\n\n\
