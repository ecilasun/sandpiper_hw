...
#
# Script generated by Vivado on Sat May 31 21:05:15 -0700 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blockone.sh
...
#
# Usage        : blockone.sh
#                blockone.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blockone.sh [-reset_run]
#                blockone.sh [-reset_log]
#                blockone.sh [-help]
#
...
export RDI_DATADIR="G:/Xilinx/Vivado/2024.2/data"
...
# script info
echo -e "blockone.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blockone.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L gmii_to_rgmii_v4_1_18 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L util_vector_logic_v2_0_4 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_34 -L fifo_generator_v13_2_12 -L axi_data_fifo_v2_1_34 -L axi_crossbar_v2_1_36 -L axi_protocol_converter_v2_1_35 -L axi_clock_converter_v2_1_33 -L blk_mem_gen_v8_4_10 -L axi_dwidth_converter_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blockone xil_defaultlib.blockone xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blockone -key {Behavioral:sim_1:Functional:blockone} -tclbatch cmd.tcl -protoinst "protoinst_files/blockone.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blockone.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blockone.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blockone.sh [-help]\n\
Usage: blockone.sh [-step]\n\
Usage: blockone.sh [-lib_map_path]\n\
Usage: blockone.sh [-reset_run]\n\
Usage: blockone.sh [-reset_log]\n\
Usage: blockone.sh [-keep_index]\n\
Usage: blockone.sh [-noclean_files]\n\n\
