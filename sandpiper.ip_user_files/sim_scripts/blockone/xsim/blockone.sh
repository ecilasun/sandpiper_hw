...
#
# Script generated by Vivado on Mon May 19 01:40:19 -0700 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_34 -L axi_vip_v1_1_20 -L gmii_to_rgmii_v4_1_18 -L processing_system7_vip_v1_0_22 -L util_vector_logic_v2_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blockone xil_defaultlib.blockone xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blockone -key {Behavioral:sim_1:Functional:blockone} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4389.protoinst" -protoinst "protoinst_files/blockone.protoinst" -log simulate.log
}
