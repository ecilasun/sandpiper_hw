...
//               d:/repos/testzor/testzor.gen/sources_1/bd/blockone/ip/blockone_audiomodule_0_0/blockone_audiomodule_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "blockone_audiomodule_0_0,audiomodule,{}" *) (* CORE_GENERATION_INFO = "blockone_audiomodule_0_0,audiomodule,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=audiomodule,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "audiomodule,Vivado 2024.2.2" *) 
module blockone_audiomodule_0_0(aclk, audioclock, aresetn, audiosampleclk, 
  audioSampleOutputLR, s_axi_arready, s_axi_awready, s_axi_bvalid, s_axi_rlast, s_axi_rvalid, 
  s_axi_wready, s_axi_bresp, s_axi_rresp, s_axi_bid, s_axi_rid, s_axi_rdata, s_axi_arvalid, 
  s_axi_awvalid, s_axi_bready, s_axi_rready, s_axi_wlast, s_axi_wvalid, s_axi_arburst, 
  s_axi_arlock, s_axi_arsize, s_axi_awburst, s_axi_awlock, s_axi_awsize, s_axi_arprot, 
  s_axi_awprot, s_axi_araddr, s_axi_awaddr, s_axi_arcache, s_axi_arlen, s_axi_arqos, 
  s_axi_awcache, s_axi_awlen, s_axi_awqos, s_axi_arid, s_axi_awid, s_axi_wid, s_axi_wdata, 
  s_axi_wstrb, m_axi_arready, m_axi_awready, m_axi_bvalid, m_axi_rlast, m_axi_rvalid, 
  m_axi_wready, m_axi_bresp, m_axi_rresp, m_axi_bid, m_axi_rid, m_axi_rdata, m_axi_arvalid, 
  m_axi_awvalid, m_axi_bready, m_axi_rready, m_axi_wlast, m_axi_wvalid, m_axi_arburst, 
  m_axi_arlock, m_axi_arsize, m_axi_awburst, m_axi_awlock, m_axi_awsize, m_axi_arprot, 
  m_axi_awprot, m_axi_araddr, m_axi_awaddr, m_axi_arcache, m_axi_arlen, m_axi_arqos, 
  m_axi_awcache, m_axi_awlen, m_axi_awqos, m_axi_arid, m_axi_awid, m_axi_wid, m_axi_wdata, 
  m_axi_wstrb)
/* synthesis syn_black_box black_box_pad_pin="aresetn,audioSampleOutputLR[31:0],s_axi_arready,s_axi_awready,s_axi_bvalid,s_axi_rlast,s_axi_rvalid,s_axi_wready,s_axi_bresp[1:0],s_axi_rresp[1:0],s_axi_bid[5:0],s_axi_rid[5:0],s_axi_rdata[63:0],s_axi_arvalid,s_axi_awvalid,s_axi_bready,s_axi_rready,s_axi_wlast,s_axi_wvalid,s_axi_arburst[1:0],s_axi_arlock[1:0],s_axi_arsize[2:0],s_axi_awburst[1:0],s_axi_awlock[1:0],s_axi_awsize[2:0],s_axi_arprot[2:0],s_axi_awprot[2:0],s_axi_araddr[31:0],s_axi_awaddr[31:0],s_axi_arcache[3:0],s_axi_arlen[3:0],s_axi_arqos[3:0],s_axi_awcache[3:0],s_axi_awlen[3:0],s_axi_awqos[3:0],s_axi_arid[5:0],s_axi_awid[5:0],s_axi_wid[5:0],s_axi_wdata[63:0],s_axi_wstrb[7:0],m_axi_arready,m_axi_awready,m_axi_bvalid,m_axi_rlast,m_axi_rvalid,m_axi_wready,m_axi_bresp[1:0],m_axi_rresp[1:0],m_axi_bid[5:0],m_axi_rid[5:0],m_axi_rdata[63:0],m_axi_arvalid,m_axi_awvalid,m_axi_bready,m_axi_rready,m_axi_wlast,m_axi_wvalid,m_axi_arburst[1:0],m_axi_arlock[1:0],m_axi_arsize[2:0],m_axi_awburst[1:0],m_axi_awlock[1:0],m_axi_awsize[2:0],m_axi_arprot[2:0],m_axi_awprot[2:0],m_axi_araddr[31:0],m_axi_awaddr[31:0],m_axi_arcache[3:0],m_axi_arlen[3:0],m_axi_arqos[3:0],m_axi_awcache[3:0],m_axi_awlen[3:0],m_axi_awqos[3:0],m_axi_arid[5:0],m_axi_awid[5:0],m_axi_wid[5:0],m_axi_wdata[63:0],m_axi_wstrb[7:0]" */
/* synthesis syn_force_seq_prim="aclk" */
/* synthesis syn_force_seq_prim="audioclock" */
/* synthesis syn_force_seq_prim="audiosampleclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF m_axi:s_axi, ASSOCIATED_RESET aresetn, FREQ_HZ 166666672, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN blockone_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
  input audioclock /* synthesis syn_isclock = 1 */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 aresetn RST" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0" *) input aresetn;
  output audiosampleclk /* synthesis syn_isclock = 1 */;
