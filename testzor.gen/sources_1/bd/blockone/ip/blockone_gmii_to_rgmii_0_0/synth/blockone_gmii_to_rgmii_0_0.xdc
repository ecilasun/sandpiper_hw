...
#-------------------------------------------------------------------
set_property IDELAY_VALUE  "16"   [get_cells -hier -filter {name =~ *blockone_gmii_to_rgmii_0_0_core/*delay_rgmii_rx_ctl          }]
set_property IDELAY_VALUE  "16"   [get_cells -hier -filter {name =~ *blockone_gmii_to_rgmii_0_0_core/*delay_rgmii_rxd*            }]
set_property IODELAY_GROUP "gpr1" [get_cells -hier -filter {name =~ *blockone_gmii_to_rgmii_0_0_core/*delay_rgmii_rx_ctl          }]
set_property IODELAY_GROUP "gpr1" [get_cells -hier -filter {name =~ *blockone_gmii_to_rgmii_0_0_core/*delay_rgmii_rxd*            }]
set_property IODELAY_GROUP "gpr1" [get_cells -hier -filter {name =~ *i_blockone_gmii_to_rgmii_0_0_idelayctrl}]
