...
#create_generated_clock -name audiosampleclock -source [get_pins blockone_i/audiomodule_0/inst/audiocoreInst/audioclock] -divide_by 512 [get_pins blockone_i/audiomodule_0/inst/audiocoreInst/audiosampleclk]
...
set_clock_groups -logically_exclusive -group [get_clocks -of_objects [get_pins {blockone_i/gmii_to_rgmii_0/gmii_clk_25m_out blockone_i/gmii_to_rgmii_0/gmii_clk_2_5m_out}]] -group [get_clocks -of_objects [get_pins blockone_i/gmii_to_rgmii_0/gmii_clk_125m_out]]
...
set_clock_groups -name grpA -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK1]] -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]]
set_clock_groups -name grpB -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/clk_wiz_0/audioclk]] -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]]
set_clock_groups -name grpC -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]] -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK1]]
set_clock_groups -name grpD -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]] -group [get_clocks -of_objects [get_pins blockone_i/clk_wiz_0/audioclk]]
set_clock_groups -name grpE -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/clk_wiz_0/pixelclk]] -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]]
set_clock_groups -name grpF -asynchronous -group [get_clocks -of_objects [get_pins blockone_i/processing_system7_0/FCLK_CLK0]] -group [get_clocks -of_objects [get_pins blockone_i/clk_wiz_0/pixelclk]]
